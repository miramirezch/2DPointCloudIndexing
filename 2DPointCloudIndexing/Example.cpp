...
// FileName - Fullpath to CSV File
std::string indexingFileName;
std::string queriesFileName;

std::cout<<"Nombre del Archivo a indexar:"<<'\n';
std::cin>>indexingFileName;

std::cout<<"Nombre del Archivo de consulta:"<<'\n';
std::cin>>queriesFileName;
