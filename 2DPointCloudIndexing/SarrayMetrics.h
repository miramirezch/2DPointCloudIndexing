...
struct SelectRankData{
	...
	SelectRankData(int innerProduct, int onesX, int onesY):InnerProd{innerProduct}, OnesPointX{onesX}, OnesPointY{onesY}{}
	int InnerProd;
	int OnesPointX;
	int OnesPointY;
};

SelectRankData InnerProduct(const std::pair<sdsl::sd_vector<>, int> &pointX,const std::pair<sdsl::sd_vector<>, int> &pointY)
{
	// Allow Select
...
double CosineSimilarity(const std::pair<sdsl::sd_vector<>, int>& pointX, const std::pair<sdsl::sd_vector<>, int>& pointY) 
{	
...
double HammingDistance(const std::pair<sdsl::sd_vector<>, int>& pointX, const std::pair<sdsl::sd_vector<>, int>& pointY) 
{
	auto selectRankData = InnerProduct(pointX,pointY);	
	return selectRankData.OnesPointX + selectRankData.OnesPointY - (2*selectRankData.InnerProd);	
}

double JaccardSimilarity(const std::pair<sdsl::sd_vector<>, int>& pointX, const std::pair<sdsl::sd_vector<>, int>& pointY) 
{
	auto selectRankData = InnerProduct(pointX,pointY);	
