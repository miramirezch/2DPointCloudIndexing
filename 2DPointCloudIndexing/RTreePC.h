...
public:
	...
	template<typename D = std::chrono::milliseconds>PerformanceReport KNNPerformanceReport(const std::vector<Cloud<T>>& queryClouds, unsigned k, unsigned internalK ,std::vector<unsigned> recallAt) const
	{
